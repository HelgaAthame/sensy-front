...
const SvgComponent = forwardRef<SVGSVGElement, SvgComponentProps>(
  ({ width, height, fill, ...props }, ref) => (
    ...
    >
      ...
      <path
        d="M26 6H4v3.171l7.414 7.414.586.586V26h4v-2h2v2a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-8l-7.414-7.415A2 2 0 0 1 2 9.171V6a2 2 0 0 1 2-2h22Z" />
      <path
        d="M0 0h32v32H0z"
