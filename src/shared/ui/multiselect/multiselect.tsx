...
export const MultiSelect = ({
  ...
  return (
    <div>
      <div>{label && <Label htmlFor="multiselect">{label}</Label>}</div>
      ...
      <div className="p-4 sm:p-6 xl:p-10">
        <div className="relative mb-50 inline-block">
          <button
            ...
            className="inline-flex items-center gap-2.5 rounded-md bg-primary py-3 px-5.5 font-medium hover:bg-opacity-95"
          >
            {selectedOptions.map((option, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex h-6 w-6 items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white sm:h-11 sm:w-11 cursor-pointer"
                >
                  <svg
                    width="24"
                    height="24"
          ...
          >
            <ul className="flex flex-col">
              {options.map((option) => (
                <li key={option.value}>
                  <button className="flex py-2 px-5 font-medium hover:bg-whiter hover:text-primary dark:hover:bg-meta-4">
                    {option.label}
                  </button>
                </li>
              ))}
