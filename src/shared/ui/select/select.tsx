...
const Select: React.FC<SelectProps> = ({
  ...
  const baseClasses = `h-11 w-full appearance-none rounded-lg border px-4 py-2.5 pr-11 text-sm shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-1`
  ...
  const textColor = value ? 'text-gray-800 dark:text-white/90' : 'text-gray-400 dark:text-gray-400'
